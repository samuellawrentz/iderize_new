...
var SlideNav = function () {
	...
	_createClass(SlideNav, [{
			...
			try {
				for (var _iterator2 = this.navAnchors[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
					...
					var linkHash = this.getHash(anchor.href),
						...
						var off = this.isMobile ? 30 : 250;
					if (section && (section.offsetTop <= offset + off && section.offsetTop + section.offsetHeight - off > offset || offset + window.innerHeight == scrollHeight)) {
		...
		value: function goToSection(linkHash) {
			...
			if (section) {
				var scrollOff = this.isMobile? 0 : 90;
				var offsetTop = section.offsetTop - scrollOff;
